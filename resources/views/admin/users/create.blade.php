                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{old('user_name')}}" name="user_name" id="title" class="form-control @error('user_name') is-invalid @enderror" placeholder="{{ __('home.user_name') }}" required>
                            @error('user_name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{old('email')}}" name="email" id="title" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('home.email') }}" required>
                            @error('email')
                            <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
