        ...
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{__('dashboard.sales_categories_management')}}
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('sales_categories.create') }}" class="btn btn-brand btn-icon-sm">
                                <i class="fa fa-plus"></i> {{__('dashboard.add_new_sales_categories')}}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                ...
                <table class="table table-striped table-bordered" style="width:100%" id="quiztable" >
                    ...
                    <tbody>    
                        @foreach ($sales_categories as $item)
                        <tr>
                            <td><img src="{{ asset('img/' . $item->img) }}" height="80px" width="80px"></td>
                            <td>{{$item->title}}</td>                           
                            <td class="d-flex"><a class="" href="{{route('sales_categories.edit',$item->id)}}"><i class="far fa-edit"></i></a>
                                ...
                                <div class="modal fade" id="delete_modal{{ $item->id }}" aria-hidden="true" role="dialog">
                                                   <div class="modal-dialog modal-dialog-centered" role="document" >
                                                       <div class="modal-content">
                                                           <form action="{{route('sales_categories.destroy',$item->id)}}" method="post">
                                                               @csrf
                                                               @method('delete')
