                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                <a class="" style="border-style:none;color: #1100ff;background-color: transparent"  href="{{route('contactus.show',$item->id)}}">
                               ...
                               <div class="modal fade" id="delete_modal{{ $item->id }}" aria-hidden="true" role="dialog">
                                   <div class="modal-dialog modal-dialog-centered" role="document" >
                                       <div class="modal-content">
                                           ...
                                           <form action="{{route('contactus.destroy',$item->id)}}" method="post">
                                               @csrf
                                               @method('delete')
