            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        {{ __('home.edit_customer') }}
                    </h3>
                </div>
            </div>
            <!--begin::Form-->
            <div class="container p-5">
            <form class="kt-form" method="post" action="{{ route('customers.update',$customer->id) }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <input type="text" value="{{ old('first_name',$customer->first_name) }}" name="first_name" id="title"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <input type="text" value="{{ old('last_name',$customer->last_name) }}" name="last_name" id="title"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <input type="text" value="{{ old('address',$customer->address) }}" name="address" id="title"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{ old('email',$customer->email) }}" name="email" id="title"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{ old('phone',$customer->phone) }}" name="phone" id="title"
                                ...
                                <select class="wide w-100 form-control @error('email') is-invalid @enderror" name="city" id="city">
                                    <option value="" data-display="Select" id="country_name">Choose...</option>
                                        @foreach ($cities as $city)
                                            <option value="{{ $city->city_id }}"  @if($city->city_id ==$customer->city) selected @endif>{{ $city->city_name }}</option>
                                        @endforeach
                                </select>
                                    @error('city')
                                        <p class="invalid-feedback">{{ $message }}</p>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <select name="country" class="form-control">
                                ...
                                @foreach (Symfony\Component\Intl\Countries::getNames() as $code => $name)
                                    <option value="{{ $name }}"  @if ($name == old('country',$customer->country)) selected @endif >{{ $name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('country')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <input type="text" value="{{ old('postal_code',$customer->postal_code) }}" name="postal_code" id="title"
