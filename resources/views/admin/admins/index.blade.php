            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{ __('dashboard.admins_management') }}
                    </h3>
                </div>
                    ...
                    <div class="kt-portlet__head-wrapper">
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('admins.create') }}" class="btn btn-brand btn-icon-sm">
                                <i class="fa fa-plus"></i> {{ __('dashboard.add_new_admins') }}
                            </a>
                ...
                <table class="table table-striped table-bordered" style="width:100%" id="quiztable" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="status"><a href="{{route('admins.status',$admin->id)}}"><i class="fa fa-times"></i></a>{{ __('dashboard.inactive') }}</td>
                            @else
                            <td class="status"><a href="{{route('admins.status',$admin->id)}}"><i class="fa fa-check" style="color:green"></i></a>{{ __('dashboard.active') }}</td>
                            @endif

                            <td class="d-flex"><a class="" href="{{route('admins.edit',$admin->id)}}"><i class="far fa-edit"></i></a>
                                <a class="" href="#" style="border-style:none;color: #1100ff;background-color: transparent"
                                data-toggle="modal" data-target="#delete_modal{{ $admin->id }}">
                                   <i class="far fa-trash-alt"></i>
                               </a>


                               </td>
                               <div class="modal fade" id="delete_modal{{ $admin->id }}" aria-hidden="true" role="dialog">
