            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{__('dashboard.orders_managment')}}
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="{{ route('systemOrders.create') }}" class="btn btn-brand btn-icon-sm">
                                <i class="fa fa-plus"></i>  {{__('dashboard.create_order')}}
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$order->status}}</td>
                            <td class="">
                                <a style="border-style:none;color: #1100ff;background-color: transparent" href="{{route('systemOrders.edit',$order->id)}}"><i class="far fa-edit"></i>{{__('home.edit')}}</a>
                            <!-- <a class="" style="border-style:none;color: #1100ff;background-color: transparent" data-toggle="modal" href="#delete_modal">
